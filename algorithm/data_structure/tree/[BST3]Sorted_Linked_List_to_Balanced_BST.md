## 정렬된 Linked List를 입력받아 Balaced BST만들기

출처: https://www.geeksforgeeks.org/sorted-linked-list-to-balanced-bst/     
...
1) linked list의 가운데 값을 찾아서 root로 만든다.

2) 재귀 구조로 left half와 right half에게도 1)의 작업을 수행한다. 
...
첫번째 방법은 root에서 출발해 leaf까지 만들어가는 방식이었다면 두번째 방법은 leaf에서 출발해서 root까지 만들어가는 방식이다.
